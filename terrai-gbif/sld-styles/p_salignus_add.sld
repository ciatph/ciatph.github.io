...
<sld:StyledLayerDescriptor version="1.0.0" xmlns="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" xmlns:sld="http://www.opengis.net/sld">
    <sld:UserLayer>
        ...
        <sld:UserStyle>
            <sld:Name>p_salignus_add</sld:Name>
            <sld:Title/>
                ...
                <sld:Rule>
                    <sld:RasterSymbolizer>
                        ...
                        <sld:ColorMap>
                            ...
                            <sld:ColorMapEntry color="#eeff00" label="1" opacity="1.0" quantity="1"/>
                            <sld:ColorMapEntry color="#abdda4" label="1.5" opacity="1.0" quantity="1.5"/>
                            <sld:ColorMapEntry color="#1100ff" label="2" opacity="1.0" quantity="2"/>
                        </sld:ColorMap>
                    </sld:RasterSymbolizer>
                </sld:Rule>
            </sld:FeatureTypeStyle>
