<template lang="pug">
  b-container(fluid class="container-fluid-custom bg-greylight")
    b-container(class="text-center")
      h2 AMIA Phase 1 - CRA Investment Briefs
...
export default {
  ...
  data () {
    return {
      ...
      items: [
        ...
        {
          text: 'CRA Investment Briefs - AMIA Phase 1',
          active: true
        }
      ]
    }
  ...
  async created () {
    try {
      // const links = await this.mFirebaseGetURLS('googledocs/FINAL INVESTMENT BRIEFS')
